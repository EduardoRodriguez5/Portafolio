        ...
        <div className="container-proyects" id="proyects">
            ...
            <div className="proyects__main">
                <div className="proyects__main__title">
                    <h3 className="proyects__main__title__each">Maleteo</h3>
                    <p>HTML | CSS | JAVASCRIPT | REACT JS | NODE JS | MONGODB | EXPRESS JS | MONGOOSE | GOOGLE MAPS
                        API</p>
                </div>
                ...
                <div className="proyects__main__title">
                    <h3 className="proyects__main__title__each">Musify</h3>
                    <p>HTML | CSS3 | SASS | JS |ANGULAR | NODEJS | EXPRESS | MONGODB.</p>
                </div>

                <div className="row mx-0 proyects__main__last">
